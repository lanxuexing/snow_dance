...
class ArticleProvider extends ChangeNotifier {
  static const List<Article> _initialArticles = [
    Article(
      id: 'flutter-3-44-7-8-patch-updates',
      ...
      date: '2026-07-25',
      category: 'Blog',
      path: 'assets/articles/blog/flutter-3-44-7-8-patch-updates.md',
    ),
    Article(
      id: 'flutter-recent-updates-guide',
      ...
      date: '2026-07-25',
      category: 'Blog',
      path: 'assets/articles/blog/flutter-recent-updates-guide.md',
    ),
    Article(
